...
const ServiceWhatWeOffer = () => {
  ...
  const [activeService, setActiveService] = useState("hrms_software");
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Secure cloud-based document management system",
    ...
    },
    {
      ...
      description: "Strategic business advisory and process optimization",
    ...
    },
    {
      ...
      description: "Professional websites and digital presence solutions",
    ...
    },
    {
      ...
      description: "Specialized solutions for skilled workforce management",
      ...
      stats: "Industry-leading solutions",
    ...
    },
    {
      ...
      description: "Talent acquisition and career development solutions",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                          ...
                          >
                            <div className="relative mt-1">
                              <motion.div
                                ...
                                className={`w-2 h-2 rounded-full bg-gradient-to-r ${activeServiceData.color}`}
                              />
                              <div
                                className={`absolute inset-0 rounded-full bg-gradient-to-r ${activeServiceData.color} blur-sm opacity-50`}
                              />
                            </div>
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div className="text-left">
                              <div className="font-bold text-gray-900">
                                Explore {activeServiceData.label}
                              </div>
          ...
          <div className="space-y-8">
                ...
                <div className="p-8">
                  ...
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Key benefits for UK businesses</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      >
                        <div className={`w-10 h-10 rounded-lg bg-gray-50 flex items-center justify-center ${benefit.color}`}>
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="absolute -inset-0.5 bg-gradient-to-r from-[#E60023] to-[#B8001B] rounded-3xl blur opacity-20" />
              
              <div className="relative bg-gradient-to-br from-[#E60023] to-[#B8001B] rounded-3xl shadow-2xl overflow-hidden p-8">
                <div className="text-center text-white">
                  <h3 className="text-2xl font-bold mb-3">Need Custom Solutions?</h3>
                  <p className="opacity-90 mb-6">
                    Contact us for tailored services that fit your specific business needs
                  </p>
                  <MagneticButton
                    variant="square"
                    className="bg-white text-[#E60023] px-8 py-3 rounded-xl font-bold hover:shadow-2xl hover:shadow-white/20 transition-all duration-300 flex items-center gap-3 mx-auto"
                  >
